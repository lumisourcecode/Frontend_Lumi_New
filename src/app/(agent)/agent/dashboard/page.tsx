  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card><p className="text-xs text-slate-500">Clients Enrolled</p><p className="text-2xl font-bold text-[#141B63]">{stats?.clientsEnrolled ?? "—"}</p></Card>
        <Card><p className="text-xs text-slate-500">Rides Today</p><p className="text-2xl font-bold text-[#141B63]">{stats?.ridesToday ?? "—"}</p></Card>
        <Card><p className="text-xs text-slate-500">In Transit</p><p className="text-2xl font-bold text-[#141B63]">{stats?.inTransit ?? "—"}</p></Card>
        <Card><p className="text-xs text-slate-500">Pending Approvals</p><p className="text-2xl font-bold text-amber-700">{stats?.pendingApprovals ?? "—"}</p></Card>
      </div>
